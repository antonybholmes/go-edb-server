...
# test login
curl -X POST -d 'email=antony@antonyholmes.dev' -d 'password=tod4EwVHEyCRK8encuLE' localhost:8080/login
curl localhost:8080/auth/info -H "Authorization: Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjdjMjkzMWE2LTVjNTMtNDU3Ni04NDRlLWIxYTJmOTI5MmVkNCIsImVtYWlsIjoiYW50b255QGFudG9ueWhvbG1lcy5kZXYiLCJleHAiOjE3MDc4NDg0MDV9.xDHXRVpND1f2LH1Xvd-hhwid1Vz5g5r6roJe-snJLDs"
